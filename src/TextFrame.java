...
public class TextFrame extends JFrame {
    ...
    /**
     * Constructs a TextFrame object
     * @param file TextFile object that will be open in the TextFrame
     * @throws Exception if there is something wrong with the TextFile
     */
    ...
    /**
     * This inner class implements all JButton objects an ActionListener
     */
    ...
    /**
     * This inner class implements ActionListeners to all JMenuObjects
     */
    ...
    /**
     * This class implements a MouseListener for opening the Right Click Menu
     */
    ...
    /**
     * It returns the selected text in the TextPane
    ...
    /**
     * this method is for creating the right click menu and populating it with suggestions
     */
    ...
    /**
     * Implements a Save As feature, uses JFileChooser
    ...
    public String saveAsAction(){
        ...
        try{
            ...
            recentList.addRecent(fileChooser.getSelectedFile().getName());
    ...
    /**
     * This class implements a WindowAdapter for handling action on quit.
     */
    ...
    /**
     * This method implements a close action for GUI
     * @param openWelcome true if you want to open WelcomeScreen after closing TextFrame, false if you don't
     */
    ...
    /**
     * This method automatically replaces all wrongly spelled words with their first suggestions.
     */
    public void autoCorrect(){
        for(Word word: words){
            ...
            if(!SpellChecker.isOnline){
                try{
                    spellChecker.grammarCheck(null, SpellChecker.Language.ENGLISH);
                }
                catch (Exception ex){
                    SpellChecker.Error(ex);
                }
